...
open class AnalyticsDataGoalsAPI {
    ...
    open class func getAnalyticsGoalReportPerCampaignPerDay(organisationUuid: String, fromDate: Date? = nil, dateFormat: DateFormat_getAnalyticsGoalReportPerCampaignPerDay? = nil, format: Format_getAnalyticsGoalReportPerCampaignPerDay? = nil, apiResponseQueue: DispatchQueue = Cervinodata API ClientAPI.apiResponseQueue, completion: @escaping ((_ data: String?,_ error: Error?) -> Void)) {
        getAnalyticsGoalReportPerCampaignPerDayWithRequestBuilder(organisationUuid: organisationUuid, fromDate: fromDate, dateFormat: dateFormat, format: format).execute(apiResponseQueue) { result -> Void in
            switch result {
    ...
    open class func getAnalyticsGoalReportPerCampaignPerDayWithRequestBuilder(organisationUuid: String, fromDate: Date? = nil, dateFormat: DateFormat_getAnalyticsGoalReportPerCampaignPerDay? = nil, format: Format_getAnalyticsGoalReportPerCampaignPerDay? = nil) -> RequestBuilder<String> {
        var path = "/data/analytics-goal-report-per-campaign-per-day/{organisationUuid}"
    ...
    open class func getAnalyticsGoalReportPerChannelGroupPerDay(organisationUuid: String, fromDate: Date? = nil, dateFormat: DateFormat_getAnalyticsGoalReportPerChannelGroupPerDay? = nil, format: Format_getAnalyticsGoalReportPerChannelGroupPerDay? = nil, apiResponseQueue: DispatchQueue = Cervinodata API ClientAPI.apiResponseQueue, completion: @escaping ((_ data: String?,_ error: Error?) -> Void)) {
        getAnalyticsGoalReportPerChannelGroupPerDayWithRequestBuilder(organisationUuid: organisationUuid, fromDate: fromDate, dateFormat: dateFormat, format: format).execute(apiResponseQueue) { result -> Void in
            switch result {
            case let .success(response):
                completion(response.body, nil)
            case let .failure(error):
    ...
    open class func getAnalyticsGoalReportPerChannelGroupPerDayWithRequestBuilder(organisationUuid: String, fromDate: Date? = nil, dateFormat: DateFormat_getAnalyticsGoalReportPerChannelGroupPerDay? = nil, format: Format_getAnalyticsGoalReportPerChannelGroupPerDay? = nil) -> RequestBuilder<String> {
        var path = "/data/analytics-goal-report-per-channel-group-per-day/{organisationUuid}"
        let organisationUuidPreEscape = "\(APIHelper.mapValueToPathItem(organisationUuid))"
        let organisationUuidPostEscape = organisationUuidPreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        path = path.replacingOccurrences(of: "{organisationUuid}", with: organisationUuidPostEscape, options: .literal, range: nil)
        let URLString = Cervinodata API ClientAPI.basePath + path
     ...
     * enum for parameter dateFormat
     */
    public enum DateFormat_getAnalyticsGoalReportPerDevicePerChannelGroupPerOrganisationPerViewPerDay: String, CaseIterable {
        case yyyyMmDd = "YYYY-MM-DD"
        case yyyymmdd = "YYYYMMDD"
    }
     ...
     * enum for parameter format
     */
    public enum Format_getAnalyticsGoalReportPerDevicePerChannelGroupPerOrganisationPerViewPerDay: String, CaseIterable {
        case csv = "csv"
        case json = "json"
    }
    ...
    open class func getAnalyticsGoalReportPerDevicePerChannelGroupPerOrganisationPerViewPerDay(organisationUuids: [String], fromDate: Date? = nil, dateFormat: DateFormat_getAnalyticsGoalReportPerDevicePerChannelGroupPerOrganisationPerViewPerDay? = nil, format: Format_getAnalyticsGoalReportPerDevicePerChannelGroupPerOrganisationPerViewPerDay? = nil, apiResponseQueue: DispatchQueue = Cervinodata API ClientAPI.apiResponseQueue, completion: @escaping ((_ data: String?,_ error: Error?) -> Void)) {
        getAnalyticsGoalReportPerDevicePerChannelGroupPerOrganisationPerViewPerDayWithRequestBuilder(organisationUuids: organisationUuids, fromDate: fromDate, dateFormat: dateFormat, format: format).execute(apiResponseQueue) { result -> Void in
            switch result {
            case let .success(response):
                completion(response.body, nil)
            case let .failure(error):
    ...
    /**
     Return analytics goal report per device per channel group per organisation per view per day
     - GET /data/analytics-goal-report-per-device-per-channel-group-per-organisation-per-view-per-day/{organisationUuids}
     ...
     - returns: RequestBuilder<String> 
     */
    open class func getAnalyticsGoalReportPerDevicePerChannelGroupPerOrganisationPerViewPerDayWithRequestBuilder(organisationUuids: [String], fromDate: Date? = nil, dateFormat: DateFormat_getAnalyticsGoalReportPerDevicePerChannelGroupPerOrganisationPerViewPerDay? = nil, format: Format_getAnalyticsGoalReportPerDevicePerChannelGroupPerOrganisationPerViewPerDay? = nil) -> RequestBuilder<String> {
        var path = "/data/analytics-goal-report-per-device-per-channel-group-per-organisation-per-view-per-day/{organisationUuids}"
    ...
    open class func getAnalyticsGoalReportPerDevicePerDay(organisationUuid: String, fromDate: Date? = nil, dateFormat: DateFormat_getAnalyticsGoalReportPerDevicePerDay? = nil, format: Format_getAnalyticsGoalReportPerDevicePerDay? = nil, apiResponseQueue: DispatchQueue = Cervinodata API ClientAPI.apiResponseQueue, completion: @escaping ((_ data: String?,_ error: Error?) -> Void)) {
        getAnalyticsGoalReportPerDevicePerDayWithRequestBuilder(organisationUuid: organisationUuid, fromDate: fromDate, dateFormat: dateFormat, format: format).execute(apiResponseQueue) { result -> Void in
            switch result {
            case let .success(response):
                completion(response.body, nil)
            case let .failure(error):
    ...
    open class func getAnalyticsGoalReportPerDevicePerDayWithRequestBuilder(organisationUuid: String, fromDate: Date? = nil, dateFormat: DateFormat_getAnalyticsGoalReportPerDevicePerDay? = nil, format: Format_getAnalyticsGoalReportPerDevicePerDay? = nil) -> RequestBuilder<String> {
        var path = "/data/analytics-goal-report-per-device-per-day/{organisationUuid}"
        let organisationUuidPreEscape = "\(APIHelper.mapValueToPathItem(organisationUuid))"
        let organisationUuidPostEscape = organisationUuidPreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        path = path.replacingOccurrences(of: "{organisationUuid}", with: organisationUuidPostEscape, options: .literal, range: nil)
        let URLString = Cervinodata API ClientAPI.basePath + path
    ...
    open class func getAnalyticsGoalReportPerSourceMediumPerDay(organisationUuid: String, fromDate: Date? = nil, dateFormat: DateFormat_getAnalyticsGoalReportPerSourceMediumPerDay? = nil, format: Format_getAnalyticsGoalReportPerSourceMediumPerDay? = nil, apiResponseQueue: DispatchQueue = Cervinodata API ClientAPI.apiResponseQueue, completion: @escaping ((_ data: String?,_ error: Error?) -> Void)) {
        getAnalyticsGoalReportPerSourceMediumPerDayWithRequestBuilder(organisationUuid: organisationUuid, fromDate: fromDate, dateFormat: dateFormat, format: format).execute(apiResponseQueue) { result -> Void in
            switch result {
            case let .success(response):
                completion(response.body, nil)
            case let .failure(error):
    ...
    open class func getAnalyticsGoalReportPerSourceMediumPerDayWithRequestBuilder(organisationUuid: String, fromDate: Date? = nil, dateFormat: DateFormat_getAnalyticsGoalReportPerSourceMediumPerDay? = nil, format: Format_getAnalyticsGoalReportPerSourceMediumPerDay? = nil) -> RequestBuilder<String> {
        var path = "/data/analytics-goal-report-per-source-medium-per-day/{organisationUuid}"
        let organisationUuidPreEscape = "\(APIHelper.mapValueToPathItem(organisationUuid))"
        let organisationUuidPostEscape = organisationUuidPreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        path = path.replacingOccurrences(of: "{organisationUuid}", with: organisationUuidPostEscape, options: .literal, range: nil)
        let URLString = Cervinodata API ClientAPI.basePath + path
