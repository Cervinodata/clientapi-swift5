...
open class AdvertisingDataAPI {
     ...
     * enum for parameter dateFormat
     */
    public enum DateFormat_getAdformExtendedReportPerOrganisationPerAccountPerCampaignPerDay: String, CaseIterable {
        case yyyyMmDd = "YYYY-MM-DD"
        case yyyymmdd = "YYYYMMDD"
    }
     ...
     * enum for parameter format
     */
    public enum Format_getAdformExtendedReportPerOrganisationPerAccountPerCampaignPerDay: String, CaseIterable {
        case csv = "csv"
        case json = "json"
    }
    ...
    /**
     ...
     - returns: RequestBuilder<String> 
     */
    open class func getAdformExtendedReportPerOrganisationPerAccountPerCampaignPerDayWithRequestBuilder(organisationUuids: [String], fromDate: Date? = nil, dateFormat: DateFormat_getAdformExtendedReportPerOrganisationPerAccountPerCampaignPerDay? = nil, format: Format_getAdformExtendedReportPerOrganisationPerAccountPerCampaignPerDay? = nil) -> RequestBuilder<String> {
        var localVariablePath = "/data/adform-extended-report-per-organisation-per-account-per-campaign-per-day/{organisationUuids}"
        let organisationUuidsPreEscape = "\(APIHelper.mapValueToPathItem(organisationUuids))"
        let organisationUuidsPostEscape = organisationUuidsPreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        localVariablePath = localVariablePath.replacingOccurrences(of: "{organisationUuids}", with: organisationUuidsPostEscape, options: .literal, range: nil)
        let localVariableURLString = Cervinodata API ClientAPI.basePath + localVariablePath
